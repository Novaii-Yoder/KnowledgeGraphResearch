...
def search_graph(graph, query):
    ...
    # Use OpenAIEmbedding to generate the embedding
...
def reasoning_gpt_call(question, answer, docs, path):
    ...
    messages = [
        SystemMessage(content="You are an AI assistant. Using the context given provide a detailed explanation and reasoning to the question/answer, given a specific path of reasoning."),
